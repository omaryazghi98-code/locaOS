  ...
  return (
    <div>
      <div className="topbar"><div><h1>Contrats</h1>
        ...
        <ActionButton path="/api/contracts/blank" body={{ language: 'fr' }} label="Imprimer un contrat vierge" variant="primary" />
      </div>
      <table className="tbl">
      ...
      <div className="sub" style={{ marginTop: 10 }}>
        « Contrat vierge » = papier pré-numéré traçable : à réconcilier avec une réservation, ou à annuler avec motif — les écarts de séquence sont visibles.
      </div>
    </div>
  );
}
