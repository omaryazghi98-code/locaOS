...
export const PERMISSIONS = [
  ...
  // Ops & alerts
  'ops:read', 'ops:write', 'alerts:read', 'alerts:resolve', 'reports:read', 'audit:read',
] as const;
...
export const ROLE_MATRIX: Record<RoleKey, readonly Permission[]> = {
  ...
  manager: [
    ...
    'finance:read', 'payments:write', 'deposits:write', 'deposit:release', 'cash:manage', 'ops:read', 'ops:write',
  ...
  agent: [
    ...
    'finance:read', 'payments:write', 'deposits:write', 'ops:read', 'ops:write', 'alerts:read',
  ],
  field_agent: [
    'agency:read', 'fleet:read', 'customers:read', 'reservations:read', 'contracts:read', 'inspections:read',
    'inspections:write', 'ops:read', 'ops:write', 'alerts:read',
  ],
  accountant: [
  ...
  mechanic: [
    'agency:read', 'fleet:read', 'fleet:write', 'vehicle:transition', 'inspections:read', 'ops:read', 'ops:write', 'alerts:read',
  ],
};
